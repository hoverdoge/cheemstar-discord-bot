...
async def create_db_pool():
	bot.pg_con = await asyncpg.create_pool("postgresql://cheemsdb:mhq5q6dlozka0gjv@app-8195e3b5-3c24-412a-9ba1-deaa67038db1-do-user-8553544-0.b.db.ondigitalocean.com:25060/cheemsdb?sslmode=require") ### FOR TEST: USER IS "POSTGRES", PW is normal pw
